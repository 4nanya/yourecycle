...
const protein = new Array("Tofu", "Meat", "Lentil", "Daal", "Egg white","Egg yolk","Animal product","Fried egg","Fruit");
...
const dairy = new Array("Milk", "Cheese", "Yogurt", "Curd", "Superfood", "Egg white","Animal product", "Soy milk","Fried egg","Fruit");
